...
<template>
  <div class="shell">
    ...
    <nav class="bottom-nav" aria-label="Điều hướng ứng dụng">
      <RouterLink to="/" class="bottom-nav-item" :class="{ active: isDiscoveryRoute }" :aria-current="isDiscoveryRoute ? 'page' : undefined">
      ...
      <RouterLink :to="auth.isAuthenticated ? '/library' : '/auth'" class="bottom-nav-item" :class="{ active: isLibraryRoute }" :aria-current="isLibraryRoute ? 'page' : undefined">
        <svg class="bottom-nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <RouterLink :to="auth.isAuthenticated ? '/account/security' : '/auth'" class="bottom-nav-item" :class="{ active: isAccountRoute }" :aria-current="isAccountRoute ? 'page' : undefined">
        <svg class="bottom-nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
