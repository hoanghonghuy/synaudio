...
var OperationBindings = map[string]OperationBinding{
	...
	"getApiV1AdminStoriesStoryidCanonBranchesActiveOfficial": {Response: "CanonBranchPascal", Description: "Active OFFICIAL canon branch"},
	...
	"getApiV1AdminChaptersChapteridAudioAssetidPreviewUrl":               {Response: "AudioURLResponse", Description: "Admin audio preview URL"},
