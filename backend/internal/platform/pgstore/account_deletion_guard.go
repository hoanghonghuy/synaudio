...
// RequestAccountDeletionSafely serializes account-deletion deactivation with
// the Last Active Admin invariant. The target row, guard decision, deactivation
// timestamp, and session revocation all commit atomically.
